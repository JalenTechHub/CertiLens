/**
 * CertiLens Pro - Dashboard Controller
 * 
...
const PAGE_META = {
  ...
  history:   { title: 'Scan History',  sub: 'All sites analyzed by CertiLens Pro' },
    ...
    wrap.innerHTML = `
      <div class="empty-table">
        ...
        <div style="font-size:12px;color:var(--text-muted)">
          Visit a website with CertiLens Pro active to start building your scan history.
        </div>
      </div>
    `;
    return;
